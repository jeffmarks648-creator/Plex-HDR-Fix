# Plex Desktop: HDR Tone Mapping Fix & RIFE AI Interpolation via VapourSynth with vs-mlrt plugin
...
| **Playback Speed Control** | Toggle playback speed: 0.25x, 0.5x, 0.75x, 1x, 1.25x, 1.5x, 2x, 3x, 4x |
